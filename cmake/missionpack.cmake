...
set(CGAME_MODULE_QVM_MISSIONPACK "${CGAME_MODULE_QVM}_${MISSIONPACK}")
set(GAME_MODULE_BINARY_MISSIONPACK "${GAME_MODULE_BINARY}_${MISSIONPACK}")
set(GAME_MODULE_QVM_MISSIONPACK "${GAME_MODULE_QVM}_${MISSIONPACK}")
set(UI_MODULE_BINARY_MISSIONPACK "${UI_MODULE_BINARY}_${MISSIONPACK}")
set(UI_MODULE_QVM_MISSIONPACK "${UI_MODULE_QVM}_${MISSIONPACK}")
...
if(BUILD_GAME_LIBRARIES)
    ...
    set_target_properties(${CGAME_MODULE_BINARY_MISSIONPACK} PROPERTIES
        OUTPUT_NAME "${CGAME_MODULE_BINARY}"
    ...
    set_target_properties(${GAME_MODULE_BINARY_MISSIONPACK} PROPERTIES
        OUTPUT_NAME "${GAME_MODULE_BINARY}"
        LIBRARY_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/${MISSIONPACK}")
    ...
    set_target_properties(${UI_MODULE_BINARY_MISSIONPACK} PROPERTIES
        OUTPUT_NAME "${UI_MODULE_BINARY}"
        LIBRARY_OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/${MISSIONPACK}")
endif()
...
if(BUILD_GAME_QVMS)
    add_qvm(${CGAME_MODULE_QVM_MISSIONPACK}
        ...
        OUTPUT_DIRECTORY "${CMAKE_BINARY_DIR}/${MISSIONPACK}/vm"
